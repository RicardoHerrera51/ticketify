            ...
            <form className='mt-8' onSubmit={onSubmit}>
              <div>
                <input
                  ...
                  name='email'
                  type='email'
                  className={`peer placeholder-silver text-md font-light h-10 w-64 border shadow-sm rounded-lg border-gray-300 text-gray-900 focus:outline-none mb-4 ${emailError ? 'border-rose-600' : 'border-gray-300'
                    }`}
                  placeholder='Correo'
                ...
                <div className='relative'>
                  <input
                    ...
                    name='password'
                    type='password'
                    className='mt-4 peer placeholder-silver text-md font-light h-10 w-64 border shadow-sm rounded-lg border-gray-300 text-gray-900 focus:outline-none'
